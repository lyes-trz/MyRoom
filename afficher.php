<?php
       ...
       if(isset($_POST['submit'])){
        ...
        $room =$_POST['room'];
        $resultSet = $mysqli->query("SELECT * FROM gites WHERE city LIKE '%$destination%' AND  room >= $room ");
        ...
        if($resultSet->num_rows > 0){
            while ($rows = $resultSet->fetch_assoc()) {
              ...
              $url = $rows['url'];
              $price = $rows['price'];
              $output .= "<dir class=\"col-lg-4 col-md-6\">
                           <a href=\"$url\">
                                 <img src=\"$img\" style=\"height: 250px; width: 350px;vertical-align: middle;text-align : center;margin-left:10px; margin-top:4px;\">
                           </a>
                           
                           <a href=\"$url\" style=\"text-decoration:none; \">
                           <h4 style=\"text-align : Left; margin-left:12px; font-size:23px; color:#353535;margin-top:3px;\">$name</h4>
                           </a>
                           <h4 style=\"text-align : Left; margin-left:12px; font-size:15px; color:#636364;margin-top:-5px;\">$city</h4>
                           <h5 style=\"text-align : Left; margin-left:12px; font-size:15px; color:#636364;margin-top:-7px;\">price / night   $price Dhs</h5>
                           <p style=\"text-align : Left; margin-left:12px; font-size:11px; color:#a1a0a1;margin-top:0px;\">Chambre moderne avec deux lits côte à côte. Elle dispose de tables de chevets avec liseuses, d'un bureau et d'une chaise et d'un dressing.</p>
                           </dir>";
