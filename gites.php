...
<!-- end:: Body -->
 ...
 <form method="POST" action="package.php" >
      ...
      <div class="form">
               ...
               <div> 
                   <label for="checkin" style=" float: center; 
                                              display:block;
                                              margin:0 auto;
                                               width:30%;
                                               margin-top: 25px;">Checkin</label>
                  <input class="date" type="date" name="checkin" value="<?php echo $date1; ?>" required>
               </div>
               <div> 
                   <label for="checkout" style=" float: center; 
                                              display:block;
                                              margin:0 auto;
                                               width:30%;
                                               margin-top: 25px;">Checkout</label>
                  <input class="date" type="date" name="checkout" required>
               </div>
               <div> 
                   <label for="adult" style=" float: center; 
                                              display:block;
                                              margin:0 auto;
                                               width:30%;
                                               margin-top: 25px;">Adults</label>
                  <input class="date" type="number" name="adult" placeholder="Nomber of adultes ..." required>
               </div>
               <div> 
                   <label for="child" style=" float: center; 
                                              display:block;
                                              margin:0 auto;
                                               width:30%;
                                               margin-top: 25px;">Child</label>
                  <input class="date" type="number" name="child" placeholder="Nomber of kids ..."required>
               </div>
               <div> 
                   <label for="rroom" style=" float: center; 
                                              display:block;
                                              margin:0 auto;
                                               width:30%;
                                               margin-top: 25px;">Rooms</label>
                  <input class="date" type="number" name="rroom" placeholder="Nomber of room ..." value="<?php echo $enfants; ?>" required>
               </div>
             
   

              <button class="send" type="submit" name="submit">Save</button>
