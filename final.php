    ...
    die("Connection failed: " . $conn->connect_error);
       ...
       if (isset($_POST['submit'])) 

        {
       	    ...
       	    $last = "SELECT MAX(N) AS last_id FROM reservation";
              $result = mysqli_query($conn, $last);
              $row = mysqli_fetch_array($result, MYSQLI_ASSOC);
              $last_id = $row['last_id'];
              $sql= "UPDATE reservation SET fname='$fname', lname='$lname' , email='$email' , tele='$tele' WHERE N='$last_id'";

            $output = "<p style=\"text-align : center;font-size: 14px;color:#734CEA;\"> Last name : $lname</p>
            <p style=\"text-align : center;font-size: 14px;color:#734CEA;\"> Number of Reservation : $last_id</p>";
...
<!-- end:: Body -->
                ...
                <div style="margin-bottom: 140px;">
                      <p style="text-align : center; font-size: 30px;">Thank you for your booking </p> 
              	      <p style="text-align : center; font-size: 18px; margin-top: 30px;">Your booking Details </p>
                      <?php echo $output; ?>
