...
<!-- end:: Body -->
            ...
            <form method="POST" action="final.php" style="margin-top: -10px;" >
      ...
      <div class="form" >
               ...
               <div > 
                   <label for="fname" style=" float: center; 
                                              ...
                                              margin:0 auto;
                                               width:30%;
                                               margin-top: 15px;">First name</label>
             ...
             <button class="send" style="width: 170px; margin-left: 40%;" type="submit" name="pay">Make Advance Payment</button>
  
              <button class="send" style="margin-top: -25px;margin-left: 55%;" type="submit" name="submit">Finish</button>
